...
È possibile accedere a. https://library.netapp.com/ecm/ecm_download_file/ECMLP2882082["Note sulla versione di ONTAP Select 9.11.1"^] per visualizzare i dettagli sulla versione corrente.
